...
ADR 记录仍会影响当前代码结构的决定；它们解释“为什么这样做”，而不是重复模块实现细节。

- [0001：Rust 作为文件写入边界，Node 作为 AI sidecar](0001-local-file-and-sidecar-boundaries.md)
- [0002：以 Node sidecar 承载 AI agent](0002-node-sidecar.md)
- [0006：使用 Rust/Rig 进程内 Agent runtime](0006-rust-rig-agent-runtime.md)
