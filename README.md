...
<div align="center">
  ...
  <p>
    <a href="https://github.com/nanshine/FloatNote/releases/latest/download/FloatNote_aarch64.dmg"><strong>下载 macOS · Apple Silicon</strong></a>
    &nbsp;·&nbsp;
    <a href="https://github.com/nanshine/FloatNote/releases/latest/download/FloatNote_x86_64.dmg"><strong>下载 macOS · Intel</strong></a>
    &nbsp;·&nbsp;
    <a href="https://github.com/nanshine/FloatNote/releases/latest/download/FloatNote_x86_64-setup.exe"><strong>下载 Windows · x86_64</strong></a>
  </p>
...
以下链接会直接下载 GitHub 最新正式发布版本对应平台的安装包。

- **Apple Silicon Mac**（M1/M2/M3/M4 及后续芯片）：[直接下载最新版 `.dmg`](https://github.com/nanshine/FloatNote/releases/latest/download/FloatNote_aarch64.dmg)
- **Intel Mac**：[直接下载最新版 `.dmg`](https://github.com/nanshine/FloatNote/releases/latest/download/FloatNote_x86_64.dmg)
- **Windows x86_64**：[直接下载最新版安装包](https://github.com/nanshine/FloatNote/releases/latest/download/FloatNote_x86_64-setup.exe)
