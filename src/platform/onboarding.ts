...
export type OnboardingStep = "welcome" | "capture" | "writing" | "tasks" | "split" | "assistant";
export type CapturePermissionState = "not_required" | "required" | "granted";
export type OnboardingPreviewScene = "welcome" | "capture-permission" | "capture-ready" | "capture-success" | "writing" | "tasks-closed" | "tasks-open" | "split-narrow" | "split-wide" | "assistant-unconfigured" | "assistant-configured-empty";
