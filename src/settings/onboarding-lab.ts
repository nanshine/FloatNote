...
const SCENES = ([
  ...
  ["assistant-unconfigured", "AI 未配置"], ["assistant-configured-empty", "AI 已配置空对话"],
...
export function mountOnboardingSettings(root: HTMLElement, debug: boolean): void {
  root.innerHTML = `<div class="settings-card">
    <div class="settings-line"><div><strong>新手引导</strong><small>从当前项目重新了解采集、写作、行动、双栏和 AI 助手</small></div><button class="settings-text-button" data-action="restart" type="button">重新开始</button></div>
